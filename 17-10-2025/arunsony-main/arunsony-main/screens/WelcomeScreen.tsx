  ...
  const carouselData = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          description: 'Progress from Bronze to Gold with exclusive perks.'
        }
      ]
    },
    {
      ...
      content: [
        ...
        { name: 'Silver', earning: 'Earn 15%', color: '#C0C0C0' },
        { name: 'Gold', earning: 'Earn 20%', color: '#FFD700' }
      ]
    },
    {
      id: '3',
              ...
              {item.content.map((level: any, index: number) => (
                ...
                >
                  <View style={styles.levelLeft}>
                    <AntDesign name="star" size={24} color={level.color} style={styles.levelIcon} />
