...
import { prioritizeMLMCommissions, getDisplayCommissionAmount, getCommissionSource } from '../utils/commissionUtils';
    ...
    try {
      if (user?.userId) {
        ...
        if (statsResponse.success && statsResponse.data) {
          const commissionStats = statsResponse.data;
          
          // Use utility function to prioritize MLM commissions
          const prioritizedStats = prioritizeMLMCommissions(commissionStats);
          const commissionSource = getCommissionSource(commissionStats);
          
          setCommissionStats(prioritizedStats);
          console.log('ReferralsScreen - Commission source:', commissionSource.message);
          console.log('ReferralsScreen - Commission stats set (prioritized):', prioritizedStats);
        }
