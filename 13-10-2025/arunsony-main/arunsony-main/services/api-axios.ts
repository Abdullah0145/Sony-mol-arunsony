...
class ApiService {
  ...
  async createWithdrawalRequest(amount: number, description: string, paymentMethod: string): Promise<ApiResponse> {
    try {
      const response = await this.axiosInstance.post('/api/withdrawals', {
        amount: amount,
