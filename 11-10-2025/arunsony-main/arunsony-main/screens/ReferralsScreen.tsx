  ...
  const fetchUserReferralsData = async () => {
    try {
      if (user?.userId) {
        ...
        const referralsResponse = await apiServiceAxios.getUserReferrals(user.userId);
        ...
        if (referralsResponse.success && referralsResponse.data) {
          ...
          const stats = {
            totalReferrals: referralsData.referralCount || 0,
            activeReferrals: activeReferrals,
            paidReferrals: paidReferrals,
            pendingReferrals: referrals.length - activeReferrals,
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            <View style={styles.communitySection}>
              ...
              <Text style={styles.communityText}>community-kickstart</Text>
            ...
            <View style={styles.headerButtons}>
              <TouchableOpacity 
                ...
                disabled={isLoading}
              >
                <Text style={[styles.refreshIcon, { color: isLoading ? "#666666" : "#FFD700" }]}>🔄</Text>
              </TouchableOpacity>
