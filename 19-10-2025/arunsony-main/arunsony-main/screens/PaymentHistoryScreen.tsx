...
export default function PaymentHistoryScreen({ navigation }: PaymentHistoryScreenProps) {
  ...
  const fetchRealSummaryData = async () => {
    try {
      ...
      // Process commission stats for lifetime earnings (prioritize MLM commissions over legacy bonuses)
      if (commissionStatsResponse.success && commissionStatsResponse.data) {
        ...
        setLifetimeEarnings(prioritizedStats.totalEarnings);
        console.log('✅ Commission source:', commissionSource.message);
        console.log('✅ Final lifetime earnings:', prioritizedStats.totalEarnings);
      } else {
